...
type WorkerBundle = {
   ...
   * `import.meta.ROLLUP_FILE_URL_<id>`. Keyed by `Environment` because
...
class WorkerOutputCache {
   ...
   * expression referencing it: `import.meta.ROLLUP_FILE_URL_<referenceId>`. The
...
/**
 * Reference a bundled worker entry as `import.meta.ROLLUP_FILE_URL_<id>` from the
